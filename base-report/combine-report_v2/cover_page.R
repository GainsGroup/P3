...
preamble_text3 <- 
  "This information from the 2019 NBA Draft Combine is not shared with NBA teams or third parties, but instead is distributed only to the NBA League Office and to the players, who are then free to share this information with their team, agents, or other support staff as they see fit."
