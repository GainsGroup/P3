...
library(grImport)
library(RGraphics)
source('report_v2/themes.R')
source('report_v2/draw_objects.R')
...
print(drawtable(bio_stats_df), vp = vplayout(3:6, 2:14))
print(drawtable(performance_stats_df), vp = vplayout(3:6, 15:24)) #this is directionally right, placement wise 
print(drawscore(athletecism_score, 'Athleticism', dkgrey), vp = vplayout(7:9, 15:19)) #move this guy down??
print(drawscore(mechanics_score, 'Mechanics', ltred), vp = vplayout(7:9, 20:24)) #move this guy down ??

## ROW 5-6: lollipop plot and figure
print(main_page_1_dot_plot(), vp = vplayout(8:13, 2:12))  #pull from right df, move to right area

print(fig, vp = vplayout(10:20, 14:25))  ### move mroe bottom right 

## ROW 7-8: history and acceleration plots
print(cluster_scatter, vp = vplayout(18:28, 14:25)) #this shouldnt change
