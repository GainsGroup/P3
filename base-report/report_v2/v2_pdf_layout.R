...
print(drawscore(athletecism_score, 'Athleticism', dkgrey), vp = vplayout(10:15, 15:19)) #move this guy down??
print(drawscore(mechanics_score, 'Mechanics', ltred), vp = vplayout(10:15, 20:24)) #move this guy down ??

## ROW 5-6: lollipop plot and figure
print(main_page_1_dot_plot(), vp = vplayout(8:15, 2:12))  #pull from right df, move to right area

### The V man
print(fig, vp = vplayout(17:28, 13:25))  ### move mroe bottom right 
